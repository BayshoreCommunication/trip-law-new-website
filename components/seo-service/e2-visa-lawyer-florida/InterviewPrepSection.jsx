...
const defaultSteps = [
  {
    number: '01',
    title: 'Business Plan Defense',
    description:
      'You\'ll walk through your business plan the way an officer would question it. We test your revenue assumptions, staffing timeline, and growth numbers for gaps. This session surfaces inconsistencies before an officer finds them during your real interview. Confidence in your own numbers comes from practicing the hard questions first.',
    icon: (
  ...
  {
    number: '02',
    title: 'Source of Funds Q&A Prep',
    description:
      'Officers ask direct questions about where your investment money came from. We prepare you to explain each source clearly, without hesitation or contradiction. This step matters most for gifted funds, loans or proceeds from a business sale. A clear and consistent answer carries more weight than paperwork.',
    icon: (
      <svg className="w-7 h-7 text-red-700" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
  ...
  {
    number: '03',
    title: 'Mock Consular and USCIS Interviews',
    description:
      'We run a full mock interview before your real one start to finish. This covers the tone, pacing and follow-up questions officers generally ask. You\'ll walk in knowing what to expect instead of walking in cold. Practice cuts the nerves that Trip up otherwise strong applicants.',
    icon: (
      <svg className="w-7 h-7 text-red-700" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
...
const InterviewPrepSection = ({
  ...
  title = 'How Trip Law Prepares Investors for Their E2 Visa Interview',
  description = 'A rough interview can undo months of preparation in a few wrong answers. Our e2 visa Lawyer florida at Trip Law rehearses your case until your answers match your paperwork precisely.',
  steps = defaultSteps,
}) => {
  return (
                ...
                >
                  <div className="flex items-center justify-between z-10">
                    <span className="text-xs font-bold text-red-400 uppercase tracking-widest">
                      Step {step.number} — E2 Investor Visa
                    </span>
                    <span className="text-slate-400 font-mono text-xs">Interview Practice</span>
                  </div>
