...
const HeroSection = ({
  locationTitle = 'IMMIGRATION LAWYER FOR MARRIAGE BASED GREEN CARD',
  mainHeading = 'Immigration Lawyer for Marriage Based Green Card — Secure Your Path to Permanent Residency',
  description = 'Obtaining green card through marriage is second quickest routes to permanent residency in the U.S. However USCIS requires thorough investigation of marriage authenticity and compliance with all regulations with marriage certificate. Process might be complicated but not with Trip Law. Our immigration lawyer for marriage based green card at Trip Law gets you well prepared applications to smooth the approval process. Trip Law in Florida specializes in these cases, offering tailored strategies and interview preparation.',
  ...
  return (
    <section className="relative w-full min-h-[700px] lg:min-h-[820px] flex items-center justify-center bg-slate-950 text-white overflow-hidden py-16 lg:py-28 mt-[70px]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={bgImage}
          alt="Immigration Lawyer for Marriage Based Green Card Background"
          fill
          priority
          quality={90}
                ...
                <div className="flex items-center gap-5 py-5">
                  <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-red-700/10 border border-red-700/30">
                    <svg className="w-6 h-6 text-red-700" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l-2 3h4l-2-3z" />
                    </svg>
                  </div>
                  <span className="text-white font-medium text-base sm:text-lg tracking-wide">
                    Attorney-Led Cases
