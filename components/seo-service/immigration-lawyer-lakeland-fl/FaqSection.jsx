...
const defaultFaqs = [
  {
    num: '01',
    question: 'Can an immigration lawyer help if my USCIS application has been denied?',
    answer:
      'Yes. Depending on why it was denied, an attorney can look at whether a motion to reopen, an appeal, or a fresh filing makes the most sense going forward.',
    icon: (
  ...
  },
  {
    ...
    answer:
      'It varies a lot by case type and by how backed up USCIS is at the moment, anywhere from a few months for some work permits to well over a year for certain green card and asylum cases.',
    icon: (
      <svg className="w-5 h-5 text-red-700" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
  ...
  {
    num: '03',
    question: 'Can an immigration lawyer represent me during my USCIS interview?',
    answer:
      'Yes. An attorney can sit in on the interview with you, raise legal issues as they come up, and help keep the conversation focused on what\'s actually relevant to eligibility.',
    icon: (
      <svg className="w-5 h-5 text-red-700" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
  ...
  {
    num: '04',
    question: 'How much does it cost to hire an immigration lawyer in Lakeland, FL?',
    answer:
      'Attorney fees depend on how complex the case is, and they\'re separate from whatever USCIS charges in government filing fees. Trip Law puts that fee in writing before any work begins, so clients know the full cost upfront.',
    icon: (
      <svg className="w-5 h-5 text-red-700" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
...
const FaqSection = ({
  tagline = 'IMMIGRATION LAWYER LAKELAND',
  title = 'Immigration Lawyer Lakeland FL Frequently Asked Questions',
  description = 'Answers to common questions about immigration cases, green cards, and USCIS procedures in Lakeland, Florida.',
  ...
  passportImageAlt = 'Lakeland Immigration Lawyer Answering USCIS Filing & Application FAQs',
  passportImageTitle = 'Lakeland Florida Immigration Legal Assistance & FAQ Guidance',
