...
const HeroSection = ({
  locationTitle = 'IMMIGRATION LAWYER LAKELAND FL',
  mainHeading = 'Immigration Lawyer Lakeland FL, Reliable Legal Guidance for Your U.S. Immigration Needs',
  description = "An immigration case can go sideways over something that sounds small from the outside. A form filed on an old edition. A birth certificate translation that was never certified. A date which does not quite correspond to that of a form three years earlier. It doesn't sound too small if you are the one waiting to receive the answer that could mean a job, family, or whether or not you can remain in this country at all. Trip Law was built around that reality. As an immigration lawyer lakeland fl families call when they need a case handled correctly the first time, we sit down with each client, go through their history in detail, and stay on the file from the opening review to the final USCIS decision.",
  ...
  return (
    <section className="relative w-full min-h-[700px] lg:min-h-[820px] flex items-center justify-center bg-slate-950 text-white overflow-hidden py-16 lg:py-28 mt-[70px]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={bgImage}
          alt="Immigration Lawyer Lakeland FL Background"
          fill
          priority
          quality={90}
          ...
          >
            <div className="bg-[#091424]/95 backdrop-blur-xl border border-slate-700/70 hover:border-red-700/60 rounded-2xl p-6 sm:p-9 shadow-2xl shadow-black/80 transition-all duration-300">
              <div className="flex flex-col divide-y divide-slate-800/80">
                ...
                {/* Highlight 3: Complete USCIS Guidance */}
                <div className="flex items-center gap-5 py-5">
                  <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-red-700/10 border border-red-700/30">
                    <svg
                      className="w-6 h-6 text-red-700"
                  ...
                  <span className="text-white font-medium text-base sm:text-lg tracking-wide">
                    End-to-End USCIS Representation
                  </span>
                </div>

                {/* Highlight 4: Lakeland FL Legal Practice */}
                <div className="flex items-center gap-5 pt-5">
                  ...
                  <span className="text-white font-medium text-base sm:text-lg tracking-wide">
                    Lakeland FL Immigration Services
                  </span>
                </div>
