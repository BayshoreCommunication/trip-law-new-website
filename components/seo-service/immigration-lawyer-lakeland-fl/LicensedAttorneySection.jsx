...
const LicensedAttorneySection = ({
  ...
  description = 'A lot of immigration filings get prepared by staff with little real oversight from a licensed attorney, and clients usually don\'t find out until the case has already stalled. A Florida Bar licensed attorney reviews every case personally, from the first eligibility check through the final decision. As an immigration lawyer lakeland fl clients can actually reach directly, our whole approach is built so the person who signs off on your strategy is the same person who answers your questions, preps you for the interview, and responds if USCIS or the court raises something. That\'s the difference between a filing service and actual legal representation.',
}) => {
  return (
