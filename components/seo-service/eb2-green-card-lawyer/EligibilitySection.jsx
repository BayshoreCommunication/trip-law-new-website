...
const EligibilitySection = ({
  ...
  cardTitle = 'Ready to Apply for an EB-2 Green Card?',
  cardSubtitle = 'Check Your Eligibility First',
  eligibilityListLeft = [
    "You hold an advanced degree, or a bachelor's degree plus at least 5 years of progressive experience in your field.",
    'You might qualify through exceptional ability in the sciences, arts, or business, backed by real documentation.',
    'You have a qualifying, permanent U.S. job offer, in cases where employer sponsorship is required.',
    'Your employer is willing to go through labor certification with the Department of Labor, when that applies.',
    'You may have a shot at a National Interest Waiver based on your proposed work and your qualifications.',
  ],
  eligibilityListRight = [
    'You can back up your education, experience, or exceptional ability with actual documents.',
    "The work you're proposing fits within EB-2 requirements.",
    "You've kept your immigration status in order, if you're planning to adjust status from inside the country.",
    'Your priority date is current, or close enough to let you take the next step, according to the Visa Bulletin the State Department publishes each month.',
    "You're ready to give USCIS complete, consistent information throughout the case.",
  ],
}) => {
  return (
