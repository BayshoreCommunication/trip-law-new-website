...
const HeroSection = ({
  locationTitle = 'LAKELAND DUI DEFENSE LAWYER',
  mainHeading = 'Lakeland DUI Defense Lawyer — Fight Your Charge Before It Costs You Your License',
  description = 'DUI arrest in Lakeland creates immediate legal and licensing problems. Florida considers the criminal case and license suspension as distinct issues with different procedures. Our lakeland dui defense lawyer at Trip Law helps clients understand every requirement, protect their rights and prepare for each stage ahead. An experienced dui defense lawyer in lakeland can identify legal issues early while preserving opportunities.',
  ...
  return (
    <section className="relative w-full min-h-[700px] lg:min-h-[820px] flex items-center justify-center bg-slate-950 text-white overflow-hidden py-16 lg:py-28 mt-[70px]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={bgImage}
          alt="Lakeland DUI Defense Lawyer Background"
          fill
          priority
          quality={90}
            ...
            <div className="bg-[#091424]/95 backdrop-blur-xl border border-slate-700/70 hover:border-red-700/60 rounded-2xl p-6 sm:p-9 shadow-2xl shadow-black/80 transition-all duration-300">
              <div className="flex flex-col divide-y divide-slate-800/80">
                ...
                <div className="flex items-center gap-5 py-5">
                  ...
                  <span className="text-white font-medium text-base sm:text-lg tracking-wide">
                    Licensed Trial Attorney
                  </span>
                </div>

                {/* Highlight 3: DHSMV 10-Day Window Support */}
                <div className="flex items-center gap-5 py-5">
                  <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-xl bg-red-700/10 border border-red-700/30">
                    <svg
                      className="w-6 h-6 text-red-700"
                  ...
                  <span className="text-white font-medium text-base sm:text-lg tracking-wide">
                    Fast Action 10-Day DMV Defense
                  </span>
                </div>

                {/* Highlight 4: Polk County DUI Practice */}
