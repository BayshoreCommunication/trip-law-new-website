...
const EligibilitySection = ({
  title = 'Ready to Apply for an EB3 Visa? Check Your Eligibility First',
  subtitleBold = '',
  description = 'Does your EB3 application meet every requirement before you take the next step? The EB3 category covers three types of workers. Each one has different rules for experience, education and wait times. Getting this wrong at start can cost you a year or more in delays. Our eb3 visa lawyer in Florida at Trip Law help you review your job offer, qualifications and employer requirements before petitioning.',
  bgImage = '/assets/seo-service/immigration-lawyer-for-citizenship-lakeland/eligibility-bg.png',
  cardTitle = 'Ready to Apply for an EB3 Visa?',
  cardSubtitle = 'Check Your Eligibility First',
  eligibilityListLeft = [
    'Sponsoring employers must establish a legitimate, full time permanent position within the United States.',
    'Offered wages must meet or exceed prevailing wage determinations issued by federal authorities.',
    'For skilled category, at least two years of relevant training or work experience is required.',
    'For professionals, a U.S. bachelor’s degree or foreign equivalent is needed for the position.',
  ],
  eligibilityListRight = [
    'For unskilled roles, the position requires less than two years of experience and is permanent.',
    'Employers must prove sustained financial ability to pay offered wages continuously over time.',
    'Visa numbers must remain available under statutory annual preference limits for candidate countries.',
    'If you are in the U.S., maintain lawful status throughout the PERM and I 485 processes.',
  ],
}) => {
  return (
