    ...
    details: [
      {
        value: '1',
        content:
          'Start your US career journey with the H-1B visa. It’s designed for professionals in specialized fields like IT, engineering, and healthcare. This employer-sponsored visa allows you to work in the US for up to six years. We make the application process simple and stress-free, guiding you every step of the way. Focus on your career while we handle the details.',
      ...
      },
      {
        value: '4',
        content:
          'The EB-1 visa offers a direct path to US permanent residency. It’s designed for those with extraordinary abilities, outstanding professors, researchers, or multinational executives. Our expert team will carefully prepare your case, emphasizing your exceptional qualifications to ensure a successful application. Let us help you achieve your American dream with ease.',
      ...
      },
      {
        value: '6',
        content:
          'The EB-3 visa is available for skilled workers, professionals, and unskilled workers. You can also get permanent residency via an EB-3 visa. It’s perfect for those who want to build a life and career in the US We will guide you through the complex immigration process. We make sure your skills and experience are presented convincingly.',
